...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/vmd-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/vmd-feedstock)
...
Once the `conda-forge` channel has been enabled, `vmd` can be installed with:

```
conda install vmd
```

It is possible to list all of the versions of `vmd` available on your platform with:
